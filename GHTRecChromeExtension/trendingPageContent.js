...
function insertPersonalizedButton() {
  ...
  personalized_button.style = "position: relative; padding: 5px 16px; line-height: 20px; font-weight: 500; float: left; color: var(--color-fg-default); border: 1px solid var(--color-border-default); background_color: transparent; "
...
function addRecommendContent() {
  ...
  document.querySelector("a.js-selected-navigation-item.selected.subnav-item").style = "position: relative; float: left; padding: 5px 16px; font-weight: 500; line-height: 20px; color: var(--color-fg-default); border: 1px solid var(--color-border-default); background-color:#f6f8fa;"
  
  current_element = document.getElementById("buttonInserted");
  current_element.style = "background-color: var(--color-accent-emphasis); color: var(--color-fg-on-emphasis); z-index: 2; position: relative; padding: 5px 16px; line-height: 20px; font-weight: 500; float: left; border: 1px solid var(--color-accent-emphasis);"
